...
export default class CreateMedicineDeliveryRequest extends Component {
  ...
  onSubmit = (e) => {
    e.preventDefault();
    const { name, age, gender, phone, deliveryAddress, city, prescriptionDetails, prescriptionFile, today } = this.state;
    ...
    <div className="col">
        ...
        <form encType='multipart/form-data'>
          ...
          <div className="mb-3">
            ...
            <input type="tel" name="phone" className="form-control" maxLength="10" onChange={this.handleInputChange} required />
          </div>
          <div className="mb-3">
